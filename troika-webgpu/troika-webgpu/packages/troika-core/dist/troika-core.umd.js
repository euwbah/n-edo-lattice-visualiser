(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.troika_core = {}, global.troika_animation, global.React, global.PropTypes));
          ...
          for (let i = 0, len = descriptor.length; i < len; i++) {
            ...
            // Otherwise create a new tween
              ...
              if (keyframes.length) {
                ...
                for (let j = 1, len = keyframes.length; j < len; j++) {
                  ...
                  for (let prop in props) {
                    if (props.hasOwnProperty(prop)) {
                      ...
                      if (prevKeyframe) {
                        let propTween = new troikaAnimation.Tween(
                ...
                let tween = newAnimTweens[animId] = new troikaAnimation.MultiTween(keyframePropTweens, duration, delay, easing, iterations, direction);
                if (!animDesc.paused) {
                  runner.start(tween);
                }
  ...
  class HtmlOverlayContent extends React__default['default'].Component {
    ...
    render () {
      ...
      return typeof html === 'string'
        ? React__default['default'].createElement('span', null, html)
        : React__default['default'].cloneElement(html)
    }
  }

  HtmlOverlayContent.displayName = 'Canvas3D.HtmlOverlayContent';
  HtmlOverlayContent.propTypes = {
    html: T__default['default'].node
  };

  class HtmlOverlay extends React__default['default'].Component {
    constructor (props) {
      super(props);
        ...
        ? React__default['default'].createElement(
          ...
          items.map(({ key, html, x, y, z, exact }) => {
            ...
            return React__default['default'].createElement(
              ...
              React__default['default'].createElement(HtmlOverlayContent, {html})
            )
          })
        )
        : null
  ...
  class Stats extends React__default['default'].Component {
    constructor(props) {
      super(props);
      this.state = {stats: {}};
    }
      ...
      return (
        React__default['default'].createElement(
          ...
          Object.keys(stats).sort().map(key =>
            React__default['default'].createElement('div', {key}, `${ key }: ${ stats[key] }`)
          )
        )
      )
    }
  ...
  class CanvasBase extends React__default['default'].Component {
    constructor(props) {
      super(props);
      this._stats = {};
    ...
    render() {
      ...
      return (
        React__default['default'].createElement(
          ...
          this._failedWorldInit ? this.props.children : React__default['default'].createElement(
            'canvas',
            {
          ...
          React__default['default'].createElement(HtmlOverlay, {ref: this._bindHtmlOverlayRef}),
          props.stats ? React__default['default'].createElement(Stats, {ref: this._bindStatsRef}) : null
        )
      )
    }
  }
  ...
  CanvasBase.commonPropTypes = {
    width: T__default['default'].number.isRequired,
    height: T__default['default'].number.isRequired,
    pixelRatio: T__default['default'].number,
    worldFacade: T__default['default'].func,
    worldProps: T__default['default'].object,
    canvasStyle: T__default['default'].object,
    className: T__default['default'].string,
    continuousRender: T__default['default'].bool,
    onCanvasRef: T__default['default'].func,
    stats: T__default['default'].bool,
    cursor: T__default['default'].string
  };
