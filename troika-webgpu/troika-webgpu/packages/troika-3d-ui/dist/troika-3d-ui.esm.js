...
import { utils, ParentFacade as ParentFacade$1, ListFacade } from 'troika-core';
import { Vector2, Vector4, PlaneGeometry, MeshBasicMaterial, Color, Mesh, CylinderGeometry, Matrix4, Plane, Sphere, Vector3, TextureLoader, BackSide, SphereGeometry } from 'three';
...
import { invertMatrix4, createDerivedMaterial as createDerivedMaterial$1 } from 'troika-three-utils';
...
class UIImage3DFacade extends Object3DFacade {
  constructor(parent, texture) {
    const mesh = new Mesh(geometry$1, defaultMaterial$1.clone());
...
const cylinderMaterial = createDerivedMaterial$1(new MeshBasicMaterial({side: 2}), {
  uniforms: {
    maxValue: {value: 1}
  },
...
class ValuePlane extends Object3DFacade {
  constructor (parent) {
    const material = createDerivedMaterial$1(new MeshBasicMaterial({
      transparent: true,
      color: 0xffffff,
      polygonOffset: true,
...
class ColorPickerFacade extends Group3DFacade {
  constructor (parent) {
    ...
    const onHueSaturationDrag = e => {
      ...
      const intersection = ray.intersectPlane(tempPlane$1, new Vector3());
      if (intersection) {
...
class PopupOwner extends UIBlock3DFacade {
  constructor(parent) {
    ...
    this._popupCt = {key: 'popup', facade: ParentFacade$1};
...
export { DatGuiFacade, UIBlock3DFacade, UIImage3DFacade$1 as UIImage3DFacade, extendAsFlexNode };
